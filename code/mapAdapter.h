...
public:
    ...
    virtual bool Consume(void* const input, const uint32_t x, const uint32_t y);
};
#pragma endregion
...
public:
    ...
    virtual bool Consume(void* const input, const uint32_t x, const uint32_t y) override;
